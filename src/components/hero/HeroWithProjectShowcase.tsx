...
const HeroWithProjectShowcase = () => {
  const featuredProjects = getFeaturedProjects(3);

  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-background via-background to-muted">
...
export default HeroWithProjectShowcase;